...
map test images, and functions to assist with the correct rendering of
data with colour maps.
...
distance down the image, at which the sine wave remains discernible to
be uniform across the image. At the very bottom of the image, where
